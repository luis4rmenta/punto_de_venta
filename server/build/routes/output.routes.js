...
router.route('/')
    .get(auth_middleware_1.verifyToken, output_controller_1.getOutputs)
...
router.route('/:outputId')
    ...
    .post(auth_middleware_1.verifyToken, output_controller_1.updateOutput)
    .delete(auth_middleware_1.verifyToken, output_controller_1.deleteOutPut);
